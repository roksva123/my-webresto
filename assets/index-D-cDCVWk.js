...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function yo(e,t,n){return new J({name:`SphericalGaussianBlur`,defines:{SAMPLES:ro,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:So(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bo(){return new J({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:So(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function xo(){return new J({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:So(),fragmentShader:`
	...
	`}var Co=class extends wn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ii(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
    ...
    `,ee=d*Math.PI/180,te=Math.sin(.4),ne=Math.cos(.4),re=new J({vertexShader:`
      varying vec2 vUv;
      void main() {
        vUv = uv;
        gl_Position = vec4(position, 1.0);
      }
    `,fragmentShader:F,uniforms:{uTime:{value:0},uResolution:{value:new rn(a,u)},uMouse:{value:S.current},uTopColor:{value:P(e)},uBottomColor:{value:P(t)},uIntensity:{value:n},uInteractive:{value:i},uGlowAmount:{value:o},uPillarWidth:{value:s},uPillarHeight:{value:c},uNoiseIntensity:{value:l},uLightMode:{value:+!!p},uRotCos:{value:1},uRotSin:{value:0},uPillarRotCos:{value:Math.cos(ee)},uPillarRotSin:{value:Math.sin(ee)},uWaveSin:{value:te},uWaveCos:{value:ne}},transparent:!0,depthWrite:!1,depthTest:!1});v.current=re;let ie=new Vi(2,2);x.current=ie;let ae=new Oi(ie,re);_.add(ae);let oe=null,se=e=>{if(!i||oe)return;oe=window.setTimeout(()=>{oe=null},16);let t=r.getBoundingClientRect(),n=(e.clientX-t.left)/t.width*2-1,a=-((e.clientY-t.top)/t.height)*2+1;S.current.set(n,a)};i&&r.addEventListener(`mousemove`,se,{passive:!0});let ce=performance.now(),le=1e3/(A===`low`?30:60),ue=e=>{if(!v.current||!g.current||!y.current||!b.current)return;let t=e-ce;if(t>=le){C.current+=.016*w.current;let n=C.current;v.current.uniforms.uTime.value=n,v.current.uniforms.uRotCos.value=Math.cos(n*.3),v.current.uniforms.uRotSin.value=Math.sin(n*.3),g.current.render(y.current,b.current),ce=e-t%le}h.current=requestAnimationFrame(ue)};h.current=requestAnimationFrame(ue);let de=null,fe=()=>{de&&clearTimeout(de),de=window.setTimeout(()=>{if(!g.current||!v.current||!m.current)return;let e=m.current.clientWidth,t=m.current.clientHeight;g.current.setSize(e,t),v.current.uniforms.uResolution.value.set(e,t)},150)};return window.addEventListener(`resize`,fe,{passive:!0}),()=>{window.removeEventListener(`resize`,fe),i&&r.removeEventListener(`mousemove`,se),h.current&&cancelAnimationFrame(h.current),g.current&&(g.current.dispose(),g.current.forceContextLoss(),r.contains(g.current.domElement)&&r.removeChild(g.current.domElement)),v.current&&v.current.dispose(),x.current&&x.current.dispose(),g.current=null,v.current=null,y.current=null,b.current=null,x.current=null,h.current=null}},[T,f]),(0,_.useEffect)(()=>{w.current=r},[r]),(0,_.useEffect)(()=>{if(!v.current)return;let t=e=>{let t=new cr(e);return new G(t.r,t.g,t.b)};v.current.uniforms.uTopColor.value=t(e)},[e]),(0,_.useEffect)(()=>{if(!v.current)return;let e=e=>{let t=new cr(e);return new G(t.r,t.g,t.b)};v.current.uniforms.uBottomColor.value=e(t)},[t]),(0,_.useEffect)(()=>{v.current&&(v.current.uniforms.uIntensity.value=n)},[n]),(0,_.useEffect)(()=>{v.current&&(v.current.uniforms.uInteractive.value=i)},[i]),(0,_.useEffect)(()=>{v.current&&(v.current.uniforms.uGlowAmount.value=o)},[o]),(0,_.useEffect)(()=>{v.current&&(v.current.uniforms.uPillarWidth.value=s)},[s]),(0,_.useEffect)(()=>{v.current&&(v.current.uniforms.uPillarHeight.value=c)},[c]),(0,_.useEffect)(()=>{v.current&&(v.current.uniforms.uNoiseIntensity.value=l)},[l]),(0,_.useEffect)(()=>{v.current&&(v.current.uniforms.uLightMode.value=+!!p)},[p]),(0,_.useEffect)(()=>{if(!v.current)return;let e=d*Math.PI/180;v.current.uniforms.uPillarRotCos.value=Math.cos(e),v.current.uniforms.uPillarRotSin.value=Math.sin(e)},[d]),!T)return(0,$.jsx)(`div`,{ref:m,className:`light-pillar-container ${a}`,style:{mixBlendMode:u}})},ll={phoneNumber:`6285175249674`,message:`Halo Webresto, Saya tertarik untuk pesan paket menu QR untuk warung/restoran saya.`},ul=(e,t)=>`https://wa.me/${e}?text=${encodeURIComponent(t)}`,dl=()=>{let[e,t]=(0,_.useState)(!1),n=[{icon:ce,title:`Hemat Biaya Cetak Menu`,description:`Menu digital via QR code, tidak perlu cetak ulang berkali-kali. Update menu kapan saja dengan mudah.`},{icon:me,title:`Pelayanan 2x Lebih Cepat`,description:`Pelanggan scan QR, langsung pesan tanpa antrean panjang atau menulis manual. Proses checkout instant.`},{icon:ue,title:`Minim Kesalahan Pencatatan`,description:`Sistem otomatis mengurangi human error pada pesanan. Data terekam rapi dan terorganisir real-time.`}],r=[{name:`Paket Dasar`,price:`Rp 299.000`,period:`Sekali Bayar`,features:[`Website toko online 1 halaman`,`Menu digital unlimited`,`QR code generator`,`Cetak stiker QR (100 lembar bonus)`,`Support WhatsApp selama 1 bulan`],cta:`Pesan Sekarang`,highlighted:!1},{name:`Paket Lengkap`,price:`Rp 599.000`,period:`Sekali Bayar`,features:[`Website toko online + katalog produk`,`Menu digital unlimited + foto produk`,`QR code generator custom branding`,`Cetak stiker QR (500 lembar bonus)`,`Integrasi pembayaran online`,`Analytics & laporan penjualan`,`Support WhatsApp selama 3 bulan`],cta:`Pesan Sekarang`,highlighted:!0},{name:`Paket Premium`,price:`Rp 999.000`,period:`Sekali Bayar`,features:[`Website toko online + katalog + admin panel`,`Menu digital unlimited + foto + video`,`QR code generator custom branding + tema`,`Cetak stiker QR (1000 lembar bonus)`,`Integrasi pembayaran online lengkap`,`Analytics dashboard & laporan detail`,`Support WhatsApp + email 6 bulan`,`Training cara penggunaan`],cta:`Pesan Sekarang`,highlighted:!1}],i=ul(ll.phoneNumber,ll.message);return(0,$.jsxs)(`div`,{className:`min-h-screen text-white relative`,children:[(0,$.jsxs)(`div`,{className:`fixed inset-0 w-full h-full pointer-events-none`,children:[(0,$.jsx)(`div`,{className:`absolute inset-0`,children:(0,$.jsx)(cl,{topColor:`#0EA5E9`,bottomColor:`#06B6D4`,intensity:.8,rotationSpeed:.2,glowAmount:.003,pillarWidth:2.5,pillarHeight:.35,noiseIntensity:.4,pillarRotation:-20,quality:`high`,mixBlendMode:`screen`})}),(0,$.jsx)(`div`,{className:`absolute inset-0 opacity-60`,children:(0,$.jsx)(cl,{topColor:`#A855F7`,bottomColor:`#EC4899`,intensity:.6,rotationSpeed:.15,glowAmount:.002,pillarWidth:2,pillarHeight:.4,noiseIntensity:.35,pillarRotation:45,quality:`high`,mixBlendMode:`multiply`})})]}),(0,$.jsx)(`nav`,{className:`sticky top-0 z-50 py-4 px-4 sm:px-6 lg:px-8`,children:(0,$.jsx)(`div`,{className:`max-w-7xl mx-auto`,children:(0,$.jsxs)(`div`,{className:`bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl px-4 sm:px-6 py-3 shadow-2xl`,children:[(0,$.jsxs)(`div`,{className:`flex items-center justify-between`,children:[(0,$.jsxs)(`div`,{className:`flex items-center gap-2`,children:[(0,$.jsx)(`div`,{className:`w-10 h-10 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-lg flex items-center justify-center`,children:(0,$.jsx)(ce,{className:`w-6 h-6 text-slate-950 font-bold`})}),(0,$.jsx)(`span`,{className:`text-xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent`,children:`Webresto`})]}),(0,$.jsxs)(`div`,{className:`hidden md:flex items-center gap-8`,children:[(0,$.jsx)(`a`,{href:`#features`,className:`text-sm font-medium text-slate-300 hover:text-white transition-colors`,children:`Keunggulan`}),(0,$.jsx)(`a`,{href:`#pricing`,className:`text-sm font-medium text-slate-300 hover:text-white transition-colors`,children:`Harga`}),(0,$.jsx)(`a`,{href:i,target:`_blank`,rel:`noopener noreferrer`,className:`px-6 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg font-medium text-sm hover:shadow-lg hover:shadow-blue-500/50 transition-all`,children:`Hubungi Kami`})]}),(0,$.jsx)(`button`,{onClick:()=>t(!e),className:`md:hidden p-2 rounded-lg bg-white/10 hover:bg-white/20 transition-colors`,children:e?(0,$.jsx)(fe,{className:`w-5 h-5`}):(0,$.jsx)(ie,{className:`w-5 h-5`})})]}),e&&(0,$.jsxs)(`div`,{className:`md:hidden mt-4 pt-4 border-t border-white/10 flex flex-col gap-3`,children:[(0,$.jsx)(`a`,{href:`#features`,className:`text-sm font-medium text-slate-300 hover:text-white transition-colors`,onClick:()=>t(!1),children:`Keunggulan`}),(0,$.jsx)(`a`,{href:`#pricing`,className:`text-sm font-medium text-slate-300 hover:text-white transition-colors`,onClick:()=>t(!1),children:`Harga`}),(0,$.jsx)(`a`,{href:i,target:`_blank`,rel:`noopener noreferrer`,className:`px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg font-medium text-sm text-center hover:shadow-lg hover:shadow-blue-500/50 transition-all`,children:`Hubungi Kami`})]})]})})}),(0,$.jsx)(`section`,{className:`pt-12 sm:pt-20 pb-16 sm:pb-24 px-4 sm:px-6 lg:px-8 relative z-10`,children:(0,$.jsxs)(`div`,{className:`max-w-4xl mx-auto text-center`,children:[(0,$.jsx)(`div`,{className:`absolute top-2 right-2 text-sm text-white z-50`,children:`aufa abdillah`}),(0,$.jsxs)(`h1`,{className:`text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 leading-tight`,children:[(0,$.jsx)(`span`,{className:`bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-300 bg-clip-text text-transparent`,children:`Webresto QR Menu`}),(0,$.jsx)(`br`,{}),(0,$.jsx)(`span`,{className:`text-white`,children:`Pesan Tanpa Antrean`})]}),(0,$.jsx)(`p`,{className:`text-lg sm:text-xl text-slate-300 mb-8 max-w-2xl mx-auto text-center leading-relaxed`,children:`Digitalisasi menu restoran Anda dengan QR code. Pelanggan scan, langsung pesan, proses cepat. Hemat biaya cetak, tingkatkan penjualan.`}),(0,$.jsxs)(`div`,{className:`grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10 max-w-2xl mx-auto`,children:[(0,$.jsxs)(`div`,{className:`flex items-center justify-center gap-2 text-sm text-slate-300`,children:[(0,$.jsx)(ee,{className:`w-4 h-4 text-cyan-400`}),(0,$.jsx)(`span`,{children:`Scan QR Code`})]}),(0,$.jsxs)(`div`,{className:`flex items-center justify-center gap-2 text-sm text-slate-300`,children:[(0,$.jsx)(ee,{className:`w-4 h-4 text-cyan-400`}),(0,$.jsx)(`span`,{children:`Langsung Pesan`})]}),(0,$.jsxs)(`div`,{className:`flex items-center justify-center gap-2 text-sm text-slate-300`,children:[(0,$.jsx)(ee,{className:`w-4 h-4 text-cyan-400`}),(0,$.jsx)(`span`,{children:`Tanpa Antrean`})]})]}),(0,$.jsxs)(`div`,{className:`flex flex-col sm:flex-row items-center justify-center gap-4`,children:[(0,$.jsxs)(`a`,{href:i,target:`_blank`,rel:`noopener noreferrer`,className:`w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg font-semibold text-white hover:shadow-lg hover:shadow-blue-500/50 transition-all flex items-center justify-center gap-2 group`,children:[(0,$.jsx)(oe,{className:`w-5 h-5`}),`Pesan di WhatsApp`,(0,$.jsx)(P,{className:`w-4 h-4 group-hover:translate-x-1 transition-transform`})]}),(0,$.jsxs)(`a`,{href:`#pricing`,className:`w-full sm:w-auto px-8 py-3 bg-white/10 border border-white/20 rounded-lg font-semibold text-white hover:bg-white/20 transition-all flex items-center justify-center gap-2`,children:[(0,$.jsx)(ne,{className:`w-5 h-5`}),`Lihat Harga`]})]})]})}),(0,$.jsx)(`section`,{id:`features`,className:`py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative z-10`,children:(0,$.jsxs)(`div`,{className:`max-w-6xl mx-auto`,children:[(0,$.jsxs)(`div`,{className:`text-center mb-12 sm:mb-16`,children:[(0,$.jsx)(`h2`,{className:`text-3xl sm:text-4xl lg:text-5xl font-bold mb-4`,children:(0,$.jsx)(`span`,{className:`bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent`,children:`Keunggulan Webresto`})}),(0,$.jsx)(`p`,{className:`text-slate-400 text-lg max-w-2xl mx-auto`,children:`Solusi lengkap untuk digitalisasi menu dan sistem pemesanan restoran Anda`})]}),(0,$.jsx)(`div`,{className:`grid grid-cols-1 md:grid-cols-3 gap-6`,children:n.map((e,t)=>{let n=e.icon;return(0,$.jsxs)(`div`,{className:`group bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8 hover:border-blue-400/50 hover:bg-white/10 transition-all duration-300`,children:[(0,$.jsx)(`div`,{className:`w-14 h-14 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-xl flex items-center justify-center mb-4 group-hover:shadow-lg group-hover:shadow-blue-500/20 transition-all`,children:(0,$.jsx)(n,{className:`w-7 h-7 text-cyan-400`})}),(0,$.jsx)(`h3`,{className:`text-lg sm:text-xl font-bold mb-3 text-white`,children:e.title}),(0,$.jsx)(`p`,{className:`text-slate-400 leading-relaxed`,children:e.description})]},t)})})]})}),(0,$.jsx)(`section`,{id:`pricing`,className:`py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative z-10`,children:(0,$.jsxs)(`div`,{className:`max-w-6xl mx-auto`,children:[(0,$.jsxs)(`div`,{className:`text-center mb-12 sm:mb-16`,children:[(0,$.jsx)(`h2`,{className:`text-3xl sm:text-4xl lg:text-5xl font-bold mb-4`,children:(0,$.jsx)(`span`,{className:`bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent`,children:`Paket Harga`})}),(0,$.jsx)(`p`,{className:`text-slate-400 text-lg max-w-2xl mx-auto `,children:`Pilih paket yang sesuai dengan kebutuhan bisnis Anda. Semua paket sudah termasuk bonus cetak stiker QR.`})]}),(0,$.jsx)(`div`,{className:`grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8`,children:r.map((e,t)=>(0,$.jsxs)(`div`,{className:`relative rounded-2xl transition-all duration-300 ${e.highlighted?`md:scale-105 ring-2 ring-blue-500/50 bg-gradient-to-br from-white/10 to-white/5`:`bg-white/5 hover:bg-white/10 border border-white/10`}`,children:[e.highlighted&&(0,$.jsx)(`div`,{className:`absolute -top-4 left-1/2 transform -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full text-sm font-bold text-white shadow-lg`,children:`Rekomendasi`}),(0,$.jsxs)(`div`,{className:`p-6 sm:p-8`,children:[(0,$.jsx)(`h3`,{className:`text-xl sm:text-2xl font-bold text-white mb-2`,children:e.name}),(0,$.jsxs)(`div`,{className:`mb-2`,children:[(0,$.jsx)(`p`,{className:`text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent`,children:e.price}),(0,$.jsx)(`p`,{className:`text-sm text-slate-400`,children:e.period})]}),(0,$.jsx)(`div`,{className:`h-px bg-gradient-to-r from-white/0 via-white/20 to-white/0 my-6`}),(0,$.jsx)(`div`,{className:`space-y-3 mb-8`,children:e.features.map((e,t)=>(0,$.jsxs)(`div`,{className:`flex items-start gap-3 text-slate-300`,children:[(0,$.jsx)(ee,{className:`w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5`}),(0,$.jsx)(`span`,{className:`text-sm`,children:e})]},t))}),(0,$.jsxs)(`a`,{href:i,target:`_blank`,rel:`noopener noreferrer`,className:`w-full py-3 rounded-lg font-semibold transition-all flex items-center justify-center gap-2 group ${e.highlighted?`bg-gradient-to-r from-blue-500 to-cyan-500 text-white hover:shadow-lg hover:shadow-blue-500/50`:`bg-white/10 text-white border border-white/20 hover:bg-white/20`}`,children:[(0,$.jsx)(oe,{className:`w-5 h-5`}),e.cta,(0,$.jsx)(P,{className:`w-4 h-4 group-hover:translate-x-1 transition-transform`})]})]})]},t))}),(0,$.jsx)(`div`,{className:`mt-12 p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl`,children:(0,$.jsxs)(`p`,{className:`text-slate-300 text-center`,children:[(0,$.jsx)(`span`,{className:`font-semibold text-white`,children:`💡 Bonus Eksklusif:`}),` `,`Setiap paket sudah termasuk cetak stiker QR dan dukungan setup awal. Untuk kebutuhan custom, hubungi tim kami melalui WhatsApp.`]})})]})}),(0,$.jsx)(`section`,{className:`py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative z-10`,children:(0,$.jsx)(`div`,{className:`max-w-4xl mx-auto text-center`,children:(0,$.jsxs)(`div`,{className:`bg-gradient-to-r from-blue-500/10 to-cyan-500/10 backdrop-blur-sm border border-blue-400/50 rounded-2xl p-8 sm:p-12`,children:[(0,$.jsx)(`h2`,{className:`text-3xl sm:text-4xl font-bold mb-4 text-white`,children:`Siap Digitalisasi Menu Anda?`}),(0,$.jsx)(`p`,{className:`text-slate-300 text-lg mb-8 max-w-2xl mx-auto`,children:`Hubungi kami sekarang melalui WhatsApp untuk konsultasi gratis dan penawaran spesial.`}),(0,$.jsxs)(`a`,{href:i,target:`_blank`,rel:`noopener noreferrer`,className:`inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg font-bold text-white text-lg hover:shadow-lg hover:shadow-blue-500/50 transition-all group`,children:[(0,$.jsx)(oe,{className:`w-6 h-6`}),`Chat WhatsApp Sekarang`,(0,$.jsx)(P,{className:`w-5 h-5 group-hover:translate-x-1 transition-transform`})]})]})})}),(0,$.jsx)(`footer`,{className:`py-8 px-4 sm:px-6 lg:px-8 border-t border-white/10 relative z-10`,children:(0,$.jsxs)(`div`,{className:`max-w-6xl mx-auto`,children:[(0,$.jsxs)(`div`,{className:`grid grid-cols-1 sm:grid-cols-3 gap-8 mb-8`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`div`,{className:`flex items-center gap-2 mb-3`,children:[(0,$.jsx)(`div`,{className:`w-8 h-8 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-lg flex items-center justify-center`,children:(0,$.jsx)(ce,{className:`w-5 h-5 text-slate-950`})}),(0,$.jsx)(`span`,{className:`font-bold text-white`,children:`Webresto`})]}),(0,$.jsx)(`p`,{className:`text-sm text-slate-400`,children:`Solusi menu digital untuk restoran & warung modern.`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`h4`,{className:`font-semibold text-white mb-4`,children:`Menu`}),(0,$.jsxs)(`ul`,{className:`space-y-2 text-sm text-slate-400`,children:[(0,$.jsx)(`li`,{children:(0,$.jsx)(`a`,{href:`#features`,className:`hover:text-white transition-colors`,children:`Keunggulan`})}),(0,$.jsx)(`li`,{children:(0,$.jsx)(`a`,{href:`#pricing`,className:`hover:text-white transition-colors`,children:`Harga`})}),(0,$.jsx)(`li`,{children:(0,$.jsx)(`a`,{href:i,target:`_blank`,rel:`noopener noreferrer`,className:`hover:text-white transition-colors`,children:`Hubungi Kami`})})]})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`h4`,{className:`font-semibold text-white mb-4`,children:`Kontak`}),(0,$.jsxs)(`a`,{href:i,target:`_blank`,rel:`noopener noreferrer`,className:`text-sm text-slate-400 hover:text-white transition-colors flex items-center gap-2`,children:[(0,$.jsx)(oe,{className:`w-4 h-4`}),`WhatsApp`]})]})]}),(0,$.jsx)(`div`,{className:`h-px bg-gradient-to-r from-white/0 via-white/20 to-white/0`}),(0,$.jsx)(`div`,{className:`mt-8 text-center text-sm text-slate-500`,children:(0,$.jsx)(`p`,{children:`© 2026 Tech-Preneur Quick Launch. Dibuat untuk Kompetisi LKS PPLG.`})})]})})]})};function fl(){return(0,$.jsx)(dl,{})}(0,v.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(_.StrictMode,{children:(0,$.jsx)(fl,{})}));