    ...
    <div className="min-h-screen text-white relative">
      ...
      <div className="fixed inset-0 w-full h-full pointer-events-none">
        ...
        <div className="absolute inset-0 opacity-40">
          <LightPillar
            ...
            pillarRotation={45}
            quality="high"
            mixBlendMode="screen" /* Diubah dari multiply ke screen agar teks tidak menjadi gelap/pudar */
          />
        </div>
      </div>
      ...
      <section className="pt-12 sm:pt-20 pb-16 sm:pb-24 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          <div className="fixed top-2 right-2 text-xs text-white/50 z-50 pointer-events-none">
            aufa abdillah
          </div>

          {/* Main Headline */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 leading-tight text-center">
          ...
          <p className="text-lg sm:text-xl text-slate-300 mb-8 max-w-2xl mx-auto text-center leading-relaxed">
            Digitalisasi menu restoran Anda dengan QR code. Pelanggan scan,
            langsung pesan, proses cepat. Hemat biaya cetak, tingkatkan
            penjualan.
          </p>

          {/* Main Solution Points */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10 max-w-2xl w-full mx-auto justify-center items-center">
      ...
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16 flex flex-col items-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent inline-block">
              Keunggulan Webresto
            </h2>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto text-center">
              Solusi lengkap untuk digitalisasi menu dan sistem pemesanan
              restoran Anda
            </p>
          </div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                <div key={index} className="flex h-full">
                  <div className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 sm:p-8 hover:border-blue-400/50 hover:bg-white/10 transition-all duration-300 w-full flex flex-col justify-between">
                    <div>
                      {/* Icon Container */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16 flex flex-col items-center">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto text-center">
              ...
              sudah termasuk bonus cetak stiker QR.
            </p>
          </div>
            ...
            {pricing.map((plan, index) => (
              <div
                ...
                className={`relative rounded-2xl transition-all duration-300 flex flex-col justify-between ${
                  plan.highlighted
                    ? "ring-2 ring-blue-400 bg-gradient-to-br from-white/15 to-white/5 shadow-xl shadow-blue-500/10"
                    : "bg-white/5 hover:bg-white/10 border border-white/10"
                }`}
              >
                {/* Highlighted Badge */}
                {plan.highlighted && (
                  <div className="absolute -top-3.5 left-1/2 transform -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full text-xs font-bold text-white shadow-lg z-20">
                    Rekomendasi
                  </div>
                )}
          ...
          <div className="mt-12 p-6 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl">
            <p className="text-slate-300 text-center">
              ...
              Setiap paket sudah termasuk cetak stiker QR dan dukungan setup
              awal. Untuk kebutuhan custom, hubungi tim kami melalui WhatsApp.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 backdrop-blur-sm border border-blue-400/50 rounded-2xl p-8 sm:p-12">
            ...
            <p className="text-slate-300 text-lg mb-8 max-w-2xl mx-auto text-center">
      ...
      <footer className="py-8 px-4 sm:px-6 lg:px-8 border-t border-white/10 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 text-center text-sm text-slate-500">
            <p>
              &copy; 2026 Tech-Preneur Quick Launch. Dibuat untuk Kompetisi LKS
              PPLG.
            </p>
          </div>
        </div>
